"""
Tick-Based Backtesting Engine - Volume Exhaustion Strategy V7 (OPTIMAL)
Best of V5 entry frequency + V6 risk management.

Entry (from V5 - proven to work):
- 2 of 3: VWAP>1.15x, Vol<70%, Prox>93%
- Time: 9:45 AM - 2:00 PM
- Day gain > 50%

Risk Management (from V6 - superior):
- Hard stop: 3% (tight)
- 50% at VWAP, 50% trailing
- Breakeven stop after TP1
- Time exit: 2:30 PM

This is the OPTIMAL strategy for maximum profit.
"""
...
class TickBacktestEngineV7:
    """
    V7: OPTIMAL - Proven entry + Superior risk management
...
tick_backtest_engine_v7 = TickBacktestEngineV7()
